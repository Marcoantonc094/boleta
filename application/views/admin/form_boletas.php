              ...
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  <?php }?>
                    ...
                    <div class="box-footer">
                      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#Crear">Nuevo Usuario</button>
                    </div>
            </div>
          </div>  
        </div>
    <?php $att = array('id' => 'formBR','class'=>'','autocomplete'=>'off','enctype'=>'multipart/form-data'); echo form_open('inicio/add_u',$att); ?>
        <div class="col-md-6">
          ...
          <div align="center" class="box box-primary">
              <img src="<?php echo base_url('assets/img/login.jpg');?>" width="500" height="500">
          </div>
        </div>
      </div>
    <?php echo form_close(); ?>
          ...
          <div class="box box-primary">
              ...
              <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="afi" name="afi" placeholder="IngresarUsuario" required value="<?php echo $row->usuario;?>">
                    </div>
                    <div class="form-group">
...
<!-- *************Ocultar contraseña index.js******************
                    <div class="form-group">
                      <label for="pass">Contraseña:</label><i class="fa fa-eye" id="show"></i>
...
<!-- *************Ocultar contraseña ****************** -->
                 <div class="form-group">
                      ...
                      <div class="form-group">
                          <input ID="txtPassword" type="Password" Class="form-control" value="<?php echo $row->pass;?>" disabled> 
                        <div class="input-group-append">
                          <button id="show_password" class="btn btn-primary" type="button" onclick="mostrarPassword()"> <i class="fa fa-eye-slash icon"></i> </button>
                        </div>
                      </div>
                 </div>
...
<!-- ******************************* -->
                ...
                <div class="form-group">
                    <label for="Seleccione Tipo">Tipo de Usuario</label>
                    <select id="rol" name="rol" class="form-control" required>
                      <option disabled selected>Selecciona Moneda</option>
                      <option <?php if($row->cargo_id=='1')echo 'selected';?> value="1">Administrador</option>
                      <option <?php if($row->cargo_id=='2')echo 'selected';?> value="2">Operario</option>
        ...
        <?php  $att = array('id' => 'formBR','class'=>'','autocomplete'=>'off','enctype'=>'multipart/form-data'); echo form_open('inicio/add_u',$att); ?>
          ...
          <!-- general form elements -->
              <div class="box box-primary">
                        ...
                        <div class="form-group">
                          <label for="nom">Nombre(s) y Apellido(s):</label>
