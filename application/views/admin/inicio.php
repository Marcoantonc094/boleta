...
<script type="text/javascript">
  var gDataI = <?php echo json_encode($graIni);?>;
  var gDataF = <?php echo json_encode($graFin);?>;
  var tData = {
    nrm: <?php echo $reg;?>,
    a15: <?php echo $a15;?>,
    a10: <?php echo $a10;?>,
  ...
  <section class="content">
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="box">
            <div class="box-body">
              <canvas id="tortaChart" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%;"></canvas>
            </div>
          </div>
        </div>
        <div class="col-lg-6">
