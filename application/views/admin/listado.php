...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <?php if($tipo==0){?>
    <ol class="breadcrumb">
      <li><a class="btn btn-success" style="color: #fff;font-weight: bold; margin: 5px;" href="<?php echo base_url('dpdf')?>" target="_blank"><i class="fa fa-file-pdf-o"></i> Reporte PDF</a></li>
    </ol>
    <?php }else{?>
    <ol class="breadcrumb">
      <li><a class="btn btn-success" style="color: #fff;font-weight: bold; margin: 5px;" href="<?php echo base_url('dpdf/detailList/'.$tipo);?>" target="_blank"><i class="fa fa-file-pdf-o"></i> Reporte PDF</a></li>
    </ol>  
    <?php }?>
  </section>
  <!-- Main content -->
                ...
                <?php if($tipo==0){?> 
                  ...
                  <tr>
                    ...
                    <td>
                          ...
                          <a class="liberar" href="#" data-id="<?php echo base_url('boleta/lib_boleta/').$row->id;?>"><span class="badge bg-green"><i class="fa fa-check"></i></span></a>
                          <a class="eliminar2" href="#" data-id="<?php echo base_url('boleta/del_boleta/').$row->id;?>"><span class="badge bg-red"><i class="fa fa-trash"></i></span></a>
                          <?php }?>
                    </td>
                  </tr>
                  <?php $i++;}?>
