      ...
      <section class="sidebar">
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            ...
            <?php if(($this->session->userdata('rol') == 1) or ($this->session->userdata('rol') == 2)){ ?>
              <li><a href="<?php echo base_url('boleta');?>"><i class="fa fa-plus"></i> Registro</a></li>
            <?php }?>
              <li><a href="<?php echo base_url('detalle');?>"><i class="fa fa-search"></i> Listado General</a></li>
            </ul>
          </li>
          ...
          <li class="treeview">
           ...
           <?php if($this->session->userdata('rol') == 1){?>
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li><a href="<?php echo base_url('inicio/usuario');?>"><i class="fa fa-circle-o"></i> Administrar</a></li>
                </ul>
                </a>
              </li>
           <?php }?>
